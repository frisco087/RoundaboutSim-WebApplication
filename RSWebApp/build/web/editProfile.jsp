...
<html lang="en">
    ...
    <head>
        ...
        <title>Roundabout Sim - Edit Profile</title>
    ...
    <body>
        ...
        <nav>
            ...
            <ul class="menu">
                ...
                <li><a href="UserController?menu=Logout">Logout</a></li>
            </ul>
            <div class="burger">
                <div class="line1"></div>
                <div class="line2"></div>
        ...
        <div class="main-wrap">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a class="bc-link" href="UserController?menu=Profile">Profile</a>
                </li>
                <li class="breadcrumb-item">Update Profile</li>
            </ol>
            <div class="login-box">
                <div class="center-item">
                    <h1 data-aos="fade-up" data-aos-offset="10" data-aos-delay="200" data-aos-duration="400" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="true" data-aos-anchor-placement="top">Update Profile</h1>
                        ...
                        <div class="rowpad">
                            <div class="form">
                                <form action="UserController" method="get" class="show-form" name="user">
                                    ...
                                    <i class="fa fa-envelope-open-text icon"></i>
                                    <label>Bio</label><br>
                                    <input class="fullWidthField form-control" type="text" name="bio" id="bio" value="${user.bio}" />
                                    <br>
                                    <input class="btn" type="submit" name="menu" value="Update Profile" />
                                    <input class="btn" type="submit" name="menu" value="Delete User"/>
                                </form>
                            </div>
                        </div>
                    </div>
