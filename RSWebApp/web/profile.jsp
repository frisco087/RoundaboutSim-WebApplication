...
<html lang="en">
    ...
    <head>
        ...
        <title>Roundabout Sim - Profile</title>
    ...
    <body>
        ...
        <nav>
            ...
            <ul class="menu">
                ...
                <li><a class="active" href="UserController?menu=Profile">Profile</a></li>
                <li><a href="UserController?menu=Contact">Contact</a></li>
                <li><a href="UserController?menu=Logout">Logout</a>
            </ul>
            <div class="burger">
                <div class="line1"></div>
                <div class="line2"></div>
        ...
        <div class="main-wrap">
            ...
            <div class="center-item">
                <h1 data-aos="fade-up" data-aos-offset="10" data-aos-delay="200" data-aos-duration="400" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="true" data-aos-anchor-placement="top">Profile</h1>
